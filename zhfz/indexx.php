    ...
    <div class="login-form padding20 block-shadow" style="opacity: 1; transform: scale(1); transition: all 0.5s ease 0s;">
        <form id="form" method="post">
            ...
            <div class="form-actions">
                <button type="button" onclick="mypswd()" class="button primary">登录</button>
                <a  href="/zhfz/register/reg.html" ><button type="submit" class="button link">找回学号</button></a>
...
function sha512($data, $rawOutput=false){
        ...
        echo password_hash(sha512("123456"),PASSWORD_DEFAULT);
?>
</body></html>
