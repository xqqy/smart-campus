...
$con->query("INSERT INTO DOC (`PATH`,`NAME`,`INFO`,`HASH`) VALUES ('upload/".$doc."', '".$name."', '".$_POST['pkgnum']."M','".hash("sha256",$name)."')");
}
...
$sql="SELECT * FROM `DOC` WHERE `HASH`='".hash("sha256",$_POST['docname'])."'";
